<template>
  <div class="main-page-bottom_sidebar_mobile-info" :class="[isDemo || isAuthUserDemo ? '-demo' : '', isSidebarShown ? '-shown' : '']">
    <div class="d-flex align-items-center">
      <div class="main-page-bottom_sidebar_mobile-info-chevron" :class="[isDemo || isAuthUserDemo ? '-demo' : '', `-${dir}`, isSidebarShown ? '-shown' : '']">
        <lfx-icon-chevron-down />
      </div>
      <lfx-sidebar-bottom-mobile-info-value v-model="accountBalance" />
    </div>
    <div class="d-flex align-items-center">
      <lfx-sidebar-bottom-mobile-info-value v-model="accountProfit" :profit-class="profitClass" />
...
export default {
  name: 'LfxSidebarBottomMobileInfo',
  components: {
    LfxIconChevronDown,
    LfxIconDeposit,
